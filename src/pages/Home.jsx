          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <img
                src="/sj.jpg"
                alt="Logo"
                className="h-15 w-15 bg-transparent"
              />
              <a
                href="#home"
          ...
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            >
              ...
              <p className="text-gray-200 mb-4 mt-2">
                <b className="text-gray-800"> 👋 Hi, I'm Sujal Joshi! </b>{" "}
                <br />
                I'm a passionate Information Technology student at Gandhinagar
                Institute of Technology, currently in <br />
                my eighth semester. I specialize in web development, backend
                technologies, and real-time <br />
                applications. <br />
                <b className="text-gray-800">💻 What I Do</b>
                <li>
                  Full-Stack Web Development – Proficient in HTML, CSS,
                  JavaScript, Node.js, and MongoDB
                </li>
                <li>
                  Database Management – Skilled in working with MongoDB for
                  efficient data handling
                </li>
                <li>
                  Real-Time Applications – Developing chat applications and
                  interactive web experiences
                </li>
                <b className="text-gray-800">🚀 My Projects</b> <br />
                I have worked on exciting projects like: <br />
                ✅ A bookstore website with a user-friendly UI and backend
                integration <br />
                ...
                skills. My goal is to build digital solutions that make an
                impact.
              </p>
                ...
                <div className="p-5">
                  ...
                  <div className="flex space-x-4">
                    <motion.a
                      ...
                      className="text-blue-600 hover:text-purple-600 font-medium transition-transform"
                    ...
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-800 hover:text-black font-medium transition-transform"
                      whileHover={{ scale: 1.1, x: -5 }}
                    >
                      Source Code
                    </motion.a>
                  ...
                  {[
                    {
                      icon: FaEnvelope,
                      label: "Email",
                      value: "joshisujal85@gmail.com",
                    },
                    {
                      icon: FaPhone,
                      label: "Phone",
                      value: "(+91) 932-747-7275",
                    },
                    {
                      icon: FaMapMarkerAlt,
                      label: "Location",
          ...
          >
            ...
            >
              {[
                {
                  icon: FaGithub,
                  link: "https://github.com/sj6742 ",
                  color: "hover:text-gray-300",
                },
                {
                  icon: FaLinkedin,
                  link: "https://www.linkedin.com/in/sujal-joshi-bba621290?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
                  color: "hover:text-blue-400",
                },
                {
                  icon: FaInstagram,
                  link: "https://www.instagram.com/_s.j.03_?igsh=a3g3d2dhOG1jNzhn&utm_source=qr",
